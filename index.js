...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: Lucifer07`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: Asmith007 `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @lucifer.007_ `,'magenta'))
